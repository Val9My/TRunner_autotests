...
class SuitesPage(BasePageElement):
    ...
    def calculate_test_cases_value_as_sum_of_test_cases(self):
        ...
        passed = int(self.visible_element_get_value(SuitesPageLocators.PASSED_1_DPDN))
        failed = int(self.visible_element_get_value(SuitesPageLocators.FAILED_1_DPDN))
        blocked = int(self.visible_element_get_value(SuitesPageLocators.BLOCKED_1_DPDN))
        not_executed = int(self.visible_element_get_value(SuitesPageLocators.NOT_EXECUTED_1_VALUE))
